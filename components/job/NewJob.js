...
import { experienceOptions, industriesOptions, educationOptions, jobTypeOptions} from "./data"
...
const NewJob = ({ access_token }) => {
    ...
    const {clearErrors, error, created, newJob, setCreated, loading} = useContext(JobContext);
                ...
                <form className="form" onSubmit={submitHandler}>
                    <div className="row">
                        ...
                        <div className="col text-center mt-3">
                            <button className="createButton">{loading ? "Posting" : "Post Job"}</button>
                        </div>
                    </div>
                </form>
            </div>
